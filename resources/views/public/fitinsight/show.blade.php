                    ...
                    <div class="row">
                        @foreach($relatedBlogs as $related)
                            <div class="col-md-6 mb-4">
                                <div class="related-card" onclick="window.location.href='{{ route('fitinsight.show', $related) }}'">
                                    @if($related->featured_image_path)
                                        <img src="{{ $related->featured_image_url }}" alt="{{ $related->title }}">
                                    @else
                                        <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3" alt="{{ $related->title }}">
                                    @endif
                                    <div class="related-card-content">
                                        <h5 class="related-card-title">{{ $related->title }}</h5>
                                        <div class="related-card-meta">
                                            <span><i class="fas fa-eye"></i> {{ number_format($related->views_count) }}</span>
                                            <span><i class="fas fa-calendar"></i> {{ $related->published_at_formatted }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sidebar-card">
                    ...
                    <div class="card-body">
                        @foreach($authorBlogs as $authorBlog)
                            <div class="sidebar-item" onclick="window.location.href='{{ route('fitinsight.show', $authorBlog) }}'">
                                @if($authorBlog->featured_image_path)
                                    <img src="{{ $authorBlog->featured_image_url }}" alt="{{ $authorBlog->title }}">
                                @else
                                    <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3" alt="{{ $authorBlog->title }}">
                                @endif
                ...
                <div class="sidebar-card">
                    ...
                    <div class="card-body">
                        @foreach($categories as $category)
                            <a href="{{ route('fitinsight.category', $category) }}" class="d-block text-decoration-none mb-2">
