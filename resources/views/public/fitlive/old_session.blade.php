...
<head>
    ...
    <title>{{ $session->title }} - FitLive</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('fitlive.index') }}">
                        <i class="fas fa-broadcast-tower me-1"></i>FitLive
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('fitnews.index') }}">
    ...
    <div id="video-container" class="position-absolute top-0 start-0 w-100 h-100 bg-dark">
        ...
        <div class="position-absolute top-0 end-0 p-3" style="z-index: 5;">
            <div class="d-flex flex-column gap-2 align-items-end">
                ...
                <span id="stream-status" class="badge bg-{{ $session->isLive() ? 'success' : ($session->isScheduled() ? 'warning' : 'secondary') }} fs-6">
