...
@section('title', 'FitDoc Series - Fitness Documentary Series')
    ...
    <div class="row py-5 bg-gradient" style="background: linear-gradient(135deg, #f8ad30 0%, #e6941a 100%);">
        <div class="col-12 text-center">
            <h1 class="display-4 fw-bold mb-3 text-dark">
                <i class="fas fa-list me-3"></i>FitDoc Series
            </h1>
            <p class="lead mb-4 text-dark">Multi-part documentary series for deep fitness insights</p>
            <div class="d-flex justify-content-center gap-3">
                <a href="{{ route('fitdoc.index') }}" class="btn btn-outline-dark">
                    <i class="fas fa-arrow-left me-2"></i>Back to FitDoc
                </a>
                <a href="{{ route('fitdoc.singles') }}" class="btn btn-dark">
                    <i class="fas fa-video me-2"></i>View Singles
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="row py-5">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-white">
                    <i class="fas fa-list me-2"></i>Documentary Series
                </h2>
            ...
            <div class="text-center py-5">
                <div class="card" style="background-color: #1d1d1d; border-color: #333;">
                    <div class="card-body" style="background-color: #1d1d1d; padding: 4rem;">
                        <i class="fas fa-video fa-4x mb-4" style="color: #f8ad30;"></i>
                        <h3 class="text-white mb-3">Coming Soon!</h3>
                        <p class="text-light mb-4">We're preparing comprehensive documentary series that will take you on deep dives into fitness, nutrition, and wellness topics. Each series will feature multiple episodes for complete learning.</p>
                        <div class="d-flex justify-content-center gap-3">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="position-absolute bottom-0 start-0 m-2">
                                <span class="badge bg-dark bg-opacity-75">
                                    <i class="fas fa-list"></i> 6 Episodes
                                </span>
                            </div>
                        </div>
                        <div class="card-body" style="background-color: #1d1d1d;">
                            <h5 class="card-title text-white">Series Title</h5>
                            <p class="card-text text-light">Brief description of the documentary series...</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <small class="text-muted">
                                    <i class="fas fa-star"></i> 4.9 (85 reviews)
                                </small>
