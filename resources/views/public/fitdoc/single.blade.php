        ...
        <div class="video-player">
            @auth
                @if(auth()->user()->hasActiveSubscription('fitdoc'))
                    ...
                    <video class="video-element" id="mainVideo" 
                        ...
                        <source src="{{ $fitDoc->video_path ? asset('storage/app/public/' . $fitDoc->video_path) : 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4' }}" type="video/mp4">
                        <source src="{{ $fitDoc->video_path ? asset('storage/app/public/' . $fitDoc->video_path) : 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4' }}" type="video/webm">
                    ...
                    <div class="video-controls" id="videoControls">
                        ...
                        <div class="video-controls-buttons">
                            ...
                            <div class="video-time">
                                <span id="currentTime">0:00</span> / <span id="duration">{{ $fitDoc->duration_minutes ?? 90 }}:00</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="video-overlay">
                        <div class="video-info">
                            <div class="video-title">{{ $fitDoc->title }}</div>
                            <div class="video-meta">
                                <span><i class="fas fa-clock"></i> {{ $fitDoc->duration_minutes ?? 90 }} min</span>
                                <span><i class="fas fa-calendar"></i> {{ $fitDoc->created_at->format('Y') }}</span>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="subscription-notice">
                        ...
                        <button class="btn-subscribe" onclick="window.location.href='{{ route('subscription.plans') }}'">
            ...
            @else
                <div class="subscription-notice">
                    ...
                    <button class="btn-subscribe" onclick="window.location.href='{{ route('login') }}'">
    ...
    <div class="content-details">
        <div class="details-header">
            <div class="details-main">
                <h1 class="movie-title">{{ $fitDoc->title }}</h1>
                ...
                <div class="movie-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <span>{{ $fitDoc->created_at->format('Y') }}</span>
                    </div>
                    <div class="meta-item">
                        <i class="fas fa-clock"></i>
                        <span>{{ $fitDoc->duration_minutes ?? 90 }} minutes</span>
                    </div>
                    <div class="meta-item">
                ...
                <div class="action-buttons">
                    @auth
                        ...
                        @else
                            <button class="btn-primary" onclick="window.location.href='{{ route('subscription.plans') }}'">
