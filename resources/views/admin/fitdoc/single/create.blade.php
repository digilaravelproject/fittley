...
@section('content')
<div class="fitdoc-single-create">
    <!-- Header Section -->
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="page-title">
                    <i class="fas fa-play-circle me-3"></i>Create New Single Video
                </h1>
            </div>
            <div class="col-md-4 text-end">
                <a href="{{ route('admin.fitdoc.single.index') }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left me-2"></i>
                    Back to Single Videos
                </a>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.fitdoc.single.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="content-card mb-4">
            <div class="content-card-header">
                ...
                <p class="content-card-subtitle">Enter the basic details for your single video</p>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   class="form-control dark-input @error('duration_minutes') is-invalid @enderror" 
                                   id="duration_minutes" 
        ...
        <div class="content-card mb-4">
            <div class="content-card-header">
                ...
                <p class="content-card-subtitle">Configure the main video source</p>
            </div>
            <div class="content-card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="video_type" class="form-label">Video Source *</label>
                            <select class="form-select dark-input @error('video_type') is-invalid @enderror" 
                                    id="video_type" 
                                    name="video_type" 
                                    required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="video_url_group" style="display: none;">
                            <label for="video_url" class="form-label">Video URL/File</label>
                            <input type="url" 
                                   class="form-control dark-input @error('video_url') is-invalid @enderror" 
                                   id="video_url" 
                                   name="video_url" 
                                   value="{{ old('video_url') }}" 
                        ...
                        <div class="form-group" id="video_file_group" style="display: none;">
                            ...
                            <input type="file" 
                                   class="form-control dark-input @error('video_file') is-invalid @enderror" 
                                   id="video_file" 
                                   name="video_file" 
                                   accept="video/*">
                            <div class="form-text">Max size: 500MB. Supported formats: MP4, AVI, MOV, WMV, FLV, WEBM</div>
                            @error('video_file')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <div class="content-card mb-4">
            ...
            <div class="content-card-body">
                <div class="form-check form-switch">
                    ...
                    <div class="form-text">If unchecked, the video will be saved as a draft</div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    videoTypeSelect.addEventListener('change', function() {
        ...
        // Show relevant group
        if (videoType === 'youtube' || videoType === 's3') {
    ...
    // Trigger change events on page load to show correct fields
