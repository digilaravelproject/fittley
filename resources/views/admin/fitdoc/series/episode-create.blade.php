...
<div class="container-fluid">
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="page-title">
                    <i class="fas fa-plus me-3"></i>Add Episode
                </h1>
                <p class="page-subtitle">{{ $series->title }}</p>
            </div>
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.fitdoc.series.episodes.store', $series) }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('episode_number') is-invalid @enderror" 
                                           id="episode_number" name="episode_number" value="{{ old('episode_number', $nextEpisodeNumber) }}" min="1" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <small class="form-text text-muted">Max size: 2MB. Recommended: 16:9 aspect ratio</small>
                            @error('banner_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="series-info">
                            ...
                            <div class="info-item">
                                ...
                                <span class="value">{{ $series->episodes->count() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Create Episode
                </button>
                <a href="{{ route('admin.fitdoc.series.episodes', $series) }}" class="btn btn-secondary">
