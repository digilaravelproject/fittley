...
<div class="role-create">
    ...
    <div class="page-header mb-5">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="page-subtitle">Create a new role and assign permissions</p>
            </div>
    ...
    <div class="content-card">
        <div class="content-card-header">
            ...
            <p class="content-card-subtitle">Fill in the details to create a new role</p>
        </div>
        <div class="content-card-body">
            <form method="POST" action="{{ route('admin.roles.store') }}" class="modern-form">
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <div class="form-help">
                                Role names should be lowercase and descriptive (e.g., manager, editor, viewer)
                            </div>
                        </div>
                    </div>
