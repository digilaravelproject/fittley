...
<div class="user-create">
    ...
    <div class="content-card">
        <div class="content-card-header">
            ...
            <p class="content-card-subtitle">Fill in the details to create a new user account</p>
        </div>
