                    ...
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">
                                {{ $users->filter(fn($u) => $u->roles->contains('name','admin'))->count() }}
                            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="stat-card stat-card-info">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">
                                {{ $users->filter(fn($u) => $u->roles->contains('name','instructor'))->count() }}
                            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="stat-card stat-card-warning">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">
                                {{ $users->filter(fn($u) => $u->roles->contains('name','user'))->count() }}
                            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('admin.users.edit', $user->id) }}" class="action-btn action-btn-warning" title="Edit User">
