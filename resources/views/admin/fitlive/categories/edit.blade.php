    ...
    <div class="row">
        <div class="col-12">
            <div class="card bg-dark border-secondary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.fitlive.categories.update', $category) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select bg-dark border-secondary text-white @error('chat_mode') is-invalid @enderror" 
                                        ...
                                        <option value="during" {{ old('chat_mode', $category->chat_mode) == 'during' ? 'selected' : '' }}>
                                            During Live
                                        </option>
                                        <option value="after" {{ old('chat_mode', $category->chat_mode) == 'after' ? 'selected' : '' }}>
                                            After Live
                                        </option>
                                        <option value="off" {{ old('chat_mode', $category->chat_mode) == 'off' ? 'selected' : '' }}>
                                            Disabled
                                        </option>
                                    </select>
                                    @error('chat_mode')
