...
@section('title', 'FitLive Categories')
    ...
    <div class="page-header">
        <div class="page-header-content">
            ...
            <div class="page-actions">
                <a href="{{ route('admin.fitlive.categories.create') }}" class="btn btn-primary">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $categories->sum('sub_categories_count') ?? 0 }}</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $categories->sum('fit_live_sessions_count') ?? 0 }}</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $categories->where('chat_mode', 'during')->count() }}</div>
                                    ...
                                    <td>
                                        <div class="user-info">
                                            ...
                                            <div class="user-details">
                                                ...
                                                <div class="user-role">{{ $category->slug }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="content-stats">
                                            ...
                                            <span class="stat-item">
                                                ...
                                                {{ $category->fit_live_sessions_count ?? 0 }} Sessions
                                            </span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="date-info">
                                            ...
                                            <div class="date-secondary">{{ $category->created_at->diffForHumans() }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('admin.fitlive.categories.show', $category) }}" 
                                               class="btn btn-action btn-info" 
                                               title="View Category">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.fitlive.categories.edit', $category) }}" 
                                               class="btn btn-action btn-warning" 
                                               title="Edit Category">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.fitlive.categories.destroy', $category) }}" 
                                                  method="POST" 
                                                  class="d-inline" 
