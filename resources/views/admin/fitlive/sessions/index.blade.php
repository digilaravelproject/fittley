...
@section('title', 'FitLive Sessions')
    ...
    <div class="page-header">
        <div class="page-header-content">
            ...
            <div class="page-actions">
                <a href="{{ route('admin.fitlive.sessions.create') }}" class="btn btn-primary">
                ...
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $sessions->total() }}</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $sessions->where('status', 'live')->count() }}</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $sessions->where('status', 'scheduled')->count() }}</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $sessions->sum('viewer_peak') ?? 0 }}</div>
        ...
        <form method="GET" class="filters-form">
            <div class="filters-grid">
                ...
                <div class="filter-item filter-actions">
                    ...
                    <a href="{{ route('admin.fitlive.sessions.index') }}" class="btn btn-clear">
                                        ...
                                        <div class="session-details">
                                            <div class="session-info">
                                                ...
                                                <div class="session-meta">
                                                    ...
                                                    <span class="visibility-badge visibility-{{ $session->visibility }}">
                                                        <i class="fas fa-{{ $session->visibility == 'public' ? 'globe' : 'lock' }} me-1"></i>
                                                        {{ ucfirst($session->visibility) }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="category-instructor">
                                            ...
                                            <div class="instructor-info">
                                                ...
                                                <div class="instructor-details">
                                                    <div class="instructor-name">{{ @$session->instructor->name }}</div>
                                            ...
                                            <div class="schedule-section">
                                                @if($session->scheduled_at)
                                                    <div class="schedule-item">
                                                        ...
                                                        <span>{{ $session->scheduled_at->format('M d, H:i') }}</span>
                                                    </div>
                                                @else
                                    ...
                                    <td>
                                        <div class="session-metrics">
                                            <div class="metric-item">
                                                <span class="metric-value">{{ $session->viewer_peak ?? 0 }}</span>
                                                <span class="metric-label">Peak Viewers</span>
                                            </div>
                                            @if($session->started_at && $session->ended_at)
                                                <div class="metric-item">
                                                    <span class="metric-value">{{ $session->getDuration() }}</span>
                                            ...
                                            <div class="secondary-actions">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.fitlive.sessions.show', $session) }}">
                                                                <i class="fas fa-eye me-2"></i>View Details
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.fitlive.sessions.edit', $session) }}">
