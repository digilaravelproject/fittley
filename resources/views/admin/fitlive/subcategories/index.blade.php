            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $subCategories->avg('sort_order') ? number_format($subCategories->avg('sort_order'), 1) : '0' }}</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="sessions-count">
                                            <span class="metric-value">{{ $subCategory->fit_live_sessions_count ?? 0 }}</span>
                                            <span class="metric-label">Sessions</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="date-info">
                                            <div class="date-primary">{{ $subCategory->created_at->format('M d, Y') }}</div>
                                            <div class="date-secondary">{{ $subCategory->created_at->diffForHumans() }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <form action="{{ route('admin.fitlive.subcategories.destroy', $subCategory) }}" 
                                                  method="POST" 
                                                  class="d-inline" 
