...
<div class="admin-dashboard">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                ...
                <p class="page-subtitle">View and manage recorded FitNews streams</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number">{{ $recordings->sum('viewer_count') }}</div>
        ...
        <form method="GET" class="filters-form">
            <div class="filters-grid">
                <div class="filter-item">
                    ...
                    <select name="creator_id" class="form-select filter-select">
                ...
                <div class="filter-item filter-actions">
                    ...
                    <a href="{{ route('admin.fitnews.archive.index') }}" class="btn btn-clear">
    ...
    <div class="content-card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-list me-2"></i>Recorded Streams
            </h3>
        ...
        <div class="card-body">
            ...
            @if($recordings->count() > 0)
                <!-- Bulk Actions Form -->
                <form id="bulk-delete-form" action="{{ route('admin.fitnews.archive.bulk-delete') }}" method="POST" style="display: none;">
                    @csrf
                    ...
                    <table class="table table-modern-enhanced">
                        <thead>
                            <tr>
                                ...
                                <th width="35%">Recording Details</th>
                                <th width="20%">Creator & Date</th>
                                ...
                                <tr class="recording-row">
                                        ...
                                        <div class="recording-details">
                                            <div class="recording-thumbnail">
                                                @if($recording->thumbnail)
                                                    <img src="{{ asset('storage/app/public/' . $recording->thumbnail) }}" 
                                        ...
                                        <div class="creator-date">
                                            <div class="creator-info">
                                                <div class="creator-avatar">
                                                    @if($recording->creator->avatar)
                                                        <img src="{{ asset('storage/app/public/' . $recording->creator->avatar) }}" alt="Creator">
                                                    @else
                                                ...
                                                <div class="creator-details">
                                                    <div class="creator-name">{{ $recording->creator->name }}</div>
                                                    <div class="creator-role">Creator</div>
                                                </div>
                                            </div>
                                            <div class="date-info">
                                                <div class="date-primary">{{ $recording->ended_at->format('M d, Y') }}</div>
                                                <div class="date-secondary">{{ $recording->ended_at->format('g:i A') }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="views-count">
                                            <span class="metric-value">{{ number_format($recording->viewer_count) }}</span>
                                    ...
                                    <td>
                                        <div class="action-buttons-enhanced">
                                            <div class="primary-actions">
                                                <a href="{{ route('admin.fitnews.archive.show', $recording) }}" 
                                            ...
                                            <div class="secondary-actions">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.fitnews.archive.show', $recording) }}">
                                                                <i class="fas fa-play me-2"></i>View Recording
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.fitnews.archive.download', $recording) }}">
                                                                <i class="fas fa-download me-2"></i>Download
                                                            </a>
                                                        </li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <form action="{{ route('admin.fitnews.archive.destroy', $recording) }}" 
                ...
                <div class="empty-state">
                    ...
                    <div class="empty-state-content">
                        ...
                        <p class="empty-state-description">
                            Recordings will appear here after FitNews streams are completed with recording enabled.
                        </p>
                        <a href="{{ route('admin.fitnews.index') }}" class="btn btn-primary">
                            <i class="fas fa-newspaper me-2"></i>Manage FitNews
                        </a>
                    </div>
                </div>
            @endif
