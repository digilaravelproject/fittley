...
@section('content')
<style>
    /* Custom styling for create blog page */
    .content-wrapper {
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.fitinsight.blogs.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Main Content Column -->
                                    ...
                                    <div class="collapse" id="seoSettings">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-text">
                                                    <span id="meta-title-count">{{ strlen(old('meta_title', '')) }}</span>/60 characters
                                                </div>
                                                @error('meta_title')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                                          ...
                                                          maxlength="160" placeholder="SEO description for search engines">{{ old('meta_description') }}</textarea>
                                                <div class="form-text">
                                                    <span id="meta-desc-count">{{ strlen(old('meta_description', '')) }}</span>/160 characters
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-text">Recommended: 1200x630px for Facebook/Twitter sharing</div>
                                                @error('social_image')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control @error('social_title') is-invalid @enderror" 
                                                       id="social_title" name="social_title" value="{{ old('social_title') }}" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('social_description') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Description for social media sharing">{{ old('social_description') }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3" id="scheduled-date-group" style="display: none;">
                                            ...
                                            <select class="form-select @error('fi_category_id') is-invalid @enderror" 
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{ $category->id }}" 
                                                            {{ old('fi_category_id') == $category->id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
