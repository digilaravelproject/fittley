...
@section('title', 'Upload FitFlix Short')
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="page-title">Upload FitFlix Short</h1>
                <p class="page-subtitle">Add a new vertical short video</p>
            </div>
            <div>
        ...
        <div class="col-lg-8">
            <div class="content-card">
                ...
                <div class="content-card-body">
                    <form method="POST" action="{{ route('admin.community.fitflix-shorts.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Brief description of the short video">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Upload MP4, MOV, AVI, MKV, or WebM files (Max: 500MB)</div>
                                    @error('video_file')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Optional custom thumbnail (JPEG, PNG, WebP)</div>
                                    @error('thumbnail')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-upload me-2"></i>Upload Short
                            </button>
                            <a href="{{ route('admin.community.fitflix-shorts.index') }}" class="btn btn-outline-secondary">
                                Cancel
                            </a>
