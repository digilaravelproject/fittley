...
@section('title', 'Show FitFlix Shorts Category - ' . $fitflix_shorts_category->name)
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Show "{{ $fitflix_shorts_category->name }}" category details</p>
            </div>
            <div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $fitflix_shorts_category->name) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
