...
@section('title', 'Create Community Category')
...
<div class="admin-dashboard">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h1 class="page-title-text">
                    <i class="fas fa-folder-plus page-title-icon"></i>
                    Create Category
                </h1>
                <p class="page-subtitle">Add a new community category for organizing posts</p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.community.categories.store') }}" id="categoryForm">
        @csrf
                    ...
                    <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="color" name="color" 
                                               ...
                                               value="{{ old('color', '#f7a31a') }}" required>
                                        <input type="text" id="colorText" 
                                               class="form-control" 
                                               value="{{ old('color', '#f7a31a') }}" 
                                               pattern="^#[a-fA-F0-9]{6}$"
                                               placeholder="#f7a31a">
                                    </div>
                                    @error('color')
                        ...
                        <div class="mb-4">
                            ...
                            @error('order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Lower numbers appear first. Leave empty to add at the end.</small>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="category-preview">
                            <div class="category-preview-item">
                                <div class="category-icon" id="previewIcon" style="background-color: {{ old('color', '#f7a31a') }};">
                                    <i class="{{ old('icon', 'fas fa-folder') }}"></i>
                                </div>
                                <div class="category-info">
                                    <h6 id="previewName">{{ old('name', 'Category Name') }}</h6>
                                    <small id="previewDescription" class="text-muted">{{ old('description', 'Category description will appear here') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="submit" name="save_and_continue" value="1" class="btn btn-outline-primary">
                                <i class="fas fa-save me-2"></i>Save & Create Another
                            </button>
