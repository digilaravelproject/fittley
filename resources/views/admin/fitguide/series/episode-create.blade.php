...
<div class="episode-create">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.fitguide.series.episodes.store', $fgSeries) }}" enctype="multipart/form-data" id="episodeForm">
        @csrf
                    ...
                    <div class="content-card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4" 
                                      placeholder="Enter episode description">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
