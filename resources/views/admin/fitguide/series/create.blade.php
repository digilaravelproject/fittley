...
<div class="series-create">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.fitguide.series.store') }}" enctype="multipart/form-data" id="seriesForm">
        @csrf
                    ...
                    <div class="content-card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="5" 
                                      placeholder="Enter series description">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
