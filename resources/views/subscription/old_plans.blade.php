    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            @foreach($plans as $plan)
                <div
                    class="plan-card bg-white rounded-xl shadow-lg overflow-hidden relative {{ $plan->is_popular ? 'ring-2 ring-purple-500' : '' }}">
                    @if($plan->is_popular)
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="flex items-baseline">
                                <span
                                    class="text-3xl font-bold text-gray-900">Rs.{{ number_format($plan->price, 0) }}</span>
