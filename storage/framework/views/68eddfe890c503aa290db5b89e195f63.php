...
<?php endif; ?>
                                            <?php else: ?>
                                                <?php $__currentLoopData = $subCategory->fitLiveSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        if ($category->id == 21) {
                                                    ...
                                                    ?>
                                                    <!--<?php echo e(print_r($subCategory)); ?>-->
                                                    <?php if (isset($component)) { $__componentOriginal41b15c4f427e6d22976473ee4b2336e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal41b15c4f427e6d22976473ee4b2336e9 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <?php $__currentLoopData = $fitNewsArchive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Carbon\Carbon::parse($news->scheduled_at)->isToday()): ?> <!-- Check if scheduled_at is today -->
                                        <?php
