...
<div class="series-create">
    ...
    <div class="page-header mb-5">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="page-subtitle">Edit "<?php echo e($fgSeries->title); ?>"</p>
            </div>
    ...
    <!-- Form -->
    <form method="POST" action="<?php echo e(route('admin.fitguide.series.update', $fgSeries)); ?>" enctype="multipart/form-data" id="seriesForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="title" 
                                   name="title" 
                                   value="<?php echo e(old('title', $fgSeries->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                   id="slug" 
                                   name="slug" 
                                   value="<?php echo e(old('slug', $fgSeries->slug)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      name="description" 
                                      rows="5" 
                                      placeholder="Enter series description"><?php echo e(old('description', $fgSeries->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php echo e(old('fg_category_id', $fgSeries->fg_category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="youtube" <?php echo e(old('trailer_type', $fgSeries->trailer_type) == 'youtube' ? 'selected' : ''); ?>>YouTube</option>
                                    <option value="s3" <?php echo e(old('trailer_type', $fgSeries->trailer_type) == 's3' ? 'selected' : ''); ?>>S3 URL</option>
                                    <option value="upload" <?php echo e(old('trailer_type', $fgSeries->trailer_type) == 'upload' ? 'selected' : ''); ?>>Upload</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="trailer_url" 
                                       name="trailer_url" 
                                       value="<?php echo e(old('trailer_url', $fgSeries->trailer_url)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        id="language" 
                                        name="language">
                                    <option value="english" <?php echo e(old('language', $fgSeries->language) == 'english' ? 'selected' : ''); ?>>English</option>
                                    <option value="spanish" <?php echo e(old('language', $fgSeries->language) == 'spanish' ? 'selected' : ''); ?>>Spanish</option>
                                    <option value="french" <?php echo e(old('language', $fgSeries->language) == 'french' ? 'selected' : ''); ?>>French</option>
                                    <option value="german" <?php echo e(old('language', $fgSeries->language) == 'german' ? 'selected' : ''); ?>>German</option>
                                    <option value="other" <?php echo e(old('language', $fgSeries->language) == 'other' ? 'selected' : ''); ?>>Other</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="cost" 
                                       name="cost" 
                                       value="<?php echo e(old('cost', $fgSeries->cost)); ?>" 
                                       min="0" 
                                       step="0.01">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="total_episodes" 
                                   name="total_episodes" 
                                   value="<?php echo e(old('total_episodes', $fgSeries->total_episodes)); ?>" 
                                   min="1">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="release_date" 
                                   name="release_date" 
                                   value="<?php echo e(old('release_date', $fgSeries->release_date ? $fgSeries->release_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="feedback" 
                                   name="feedback" 
                                   value="<?php echo e(old('feedback', $fgSeries->feedback)); ?>" 
                                   min="0" 
                                   max="5" 
                                   step="0.1"
                                   placeholder="0.0">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" 
                                   ...
                                   name="is_published" 
                                   value="1"
                                   <?php echo e(old('is_published', $fgSeries->is_published) ? 'checked' : ''); ?>>
            ...
            fetch(`/admin/fitguide/categories/${categoryId}/subcategories`)
                ...
                .then(data => {
                    data.forEach(subcategory => {
                        ...
                        if (subcategory.id == <?php echo e($fgSeries->fg_sub_category_id ?? 'null'); ?>) {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/fittelly.com/public_html/resources/views/admin/fitguide/series/edit.blade.php ENDPATH**/ ?>