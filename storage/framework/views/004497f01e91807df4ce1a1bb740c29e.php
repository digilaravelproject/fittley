            ...
            <div class="tools-list row g-3">
                <?php $__currentLoopData = $tools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <a href="<?php echo e($href); ?>" class="tool-card text-decoration-none d-block h-100">
                            <div class="card shadow-sm border-0 rounded-2 h-100">
                                <div class="tools-card-body card-body d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-0"><?php echo e($tool['name']); ?></h6>
...
<?php echo $__env->make('layouts.home.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/tools/index.blade.php ENDPATH**/ ?>