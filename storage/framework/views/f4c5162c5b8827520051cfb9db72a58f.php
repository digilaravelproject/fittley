...
<?php $__env->startSection('title', $session->title . ' - FitArena'); ?>
                            ...
                            <div class="col-md-8">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted"><?php echo e($session->event->title); ?></small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 text-end">
                                <div class="d-flex align-items-center justify-content-end gap-3">
                                    <span class="text-muted">
                                        ...
                                        <span id="viewer-count"><?php echo e($session->viewer_count ?? 0); ?></span> viewers
                                    </span>
                    ...
                    <div class="d-flex align-items-center justify-content-center h-100 text-white text-center">
                        <div>
                            <?php if($session->status === 'scheduled'): ?>
                                ...
                                <h4 class="text-warning"><?php echo e($session->scheduled_start->format('M j, Y \a\t g:i A')); ?></h4>
                                <?php if($session->scheduled_start->isFuture()): ?>
                                    <p class="text-muted">
                                        <i class="fas fa-hourglass-half me-1"></i>
                                        Starts <?php echo e($session->scheduled_start->diffForHumans()); ?>
                            ...
                            <?php elseif($session->status === 'ended'): ?>
                                ...
                                <?php if($session->replay_available && $session->recording_url): ?>
                                    <a href="<?php echo e($session->recording_url); ?>" class="btn btn-primary">
        ...
        <div class="container-fluid p-3">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="text-muted mb-2"><?php echo e($session->description); ?></p>
                    
                    <div class="row g-3 text-sm">
                        <div class="col-md-3">
                            <strong>Event:</strong><br>
                            <a href="<?php echo e(route('fitarena.event', $session->event->slug)); ?>" class="text-decoration-none">
                                <?php echo e($session->event->title); ?>

                            </a>
                        </div>
                        <div class="col-md-3">
                            <strong>Stage:</strong><br>
                            <span class="text-muted"><?php echo e($session->stage->name ?? 'Main Stage'); ?></span>
                        </div>
                        <div class="col-md-3">
                            <strong>Status:</strong><br>
                            <span class="badge bg-<?php echo e($session->status_color); ?>"><?php echo e(ucfirst($session->status)); ?></span>
                        </div>
                        <div class="col-md-3">
                            <strong>Duration:</strong><br>
                            <span class="text-muted"><?php echo e($session->getFormattedScheduledDuration()); ?></span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/public/fitarena/session.blade.php ENDPATH**/ ?>