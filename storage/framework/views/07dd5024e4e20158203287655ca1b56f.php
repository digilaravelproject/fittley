...
<head>
    ...
    <title><?php echo e($session->title); ?> - FitLive</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
            <i class="fas fa-dumbbell me-2"></i>fitlley
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('fitlive.index')); ?>">
                        <i class="fas fa-broadcast-tower me-1"></i>FitLive
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('fitnews.index')); ?>">
                        <i class="fas fa-newspaper me-1"></i>FitNews
                    </a>
                </li>
            </ul>
...
<div class="video-container-wrapper position-relative" style="overflow: hidden;">
    ...
    <div id="video-container" class="position-absolute top-0 start-0 w-100 h-100 bg-dark">
            ...
            <div class="w-100 h-100 d-flex align-items-center justify-content-center text-white">
                <div class="text-center">
                    <?php if($session->banner_image): ?>
                        <img src="<?php echo e(asset('storage/app/public/' . $session->banner_image)); ?>" 
                             alt="Session banner" class="img-fluid rounded mb-3"
        ...
        <div class="position-absolute top-0 end-0 p-3" style="z-index: 5;">
            <div class="d-flex flex-column gap-2 align-items-end">
                ...
                <span id="stream-status" class="badge bg-<?php echo e($session->isLive() ? 'success' : ($session->isScheduled() ? 'warning' : 'secondary')); ?> fs-6">
    ...
    <div id="chat-panel" class="position-absolute top-0 end-0 h-100 bg-dark bg-opacity-90 text-white" style="width: 350px; z-index: 15; transform: translateX(0px); transition: transform 0.3s ease;">
    ...
    <!-- Chat Toggle Button -->
    <?php if($session->chat_mode !== 'off'): ?>
    <button id="toggle-chat" class="position-absolute btn btn-primary" style="top: 50%; right: 10px; z-index: 20; transform: translateY(-50%);">
        <i class="fas fa-times"></i>
    </button>
    <?php endif; ?>
</div>
...
</html> <?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/public/fitlive/session.blade.php ENDPATH**/ ?>