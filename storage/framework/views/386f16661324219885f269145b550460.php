...
<?php $__env->startSection('title', 'RPE Calculator'); ?>
            ...
            <div class="card bg-dark text-white border-0 shadow">
                <div class="card-body text-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-center mb-4" id="rpeButtons">
                        <?php for($i = 6; $i <= 10; $i++): ?> <!-- usually RPE 6–10 are used -->
                            <button type="button" class="btn btn-outline-light m-1 rpe-btn" data-value="<?php echo e($i); ?>">
                                <?php echo e($i); ?>
                    ...
                    <div class="d-flex flex-wrap justify-content-center mb-4" id="repButtons">
                        <?php for($i = 1; $i <= 12; $i++): ?>
                            <button type="button" class="btn btn-outline-light m-1 rep-btn" data-value="<?php echo e($i); ?>">
                                <?php echo e($i); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/tools/rpe-calculator.blade.php ENDPATH**/ ?>