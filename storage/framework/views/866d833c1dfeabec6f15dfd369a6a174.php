...
<?php $__env->startSection('title', 'Edit FitFlix Short'); ?>
        ...
        <div class="col-lg-8">
            <div class="content-card">
                ...
                <div class="content-card-body">
                    <form method="POST" 
                      action="<?php echo e(route('admin.community.fitflix-shorts.update', $fitflix_short->slug)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                           id="title" name="title" 
                                           value="<?php echo e(old('title', $fitflix_short->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" 
                                                <?php echo e(old('category_id', $fitflix_short->category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                      id="description" name="description" rows="3"><?php echo e(old('description', $fitflix_short->description)); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_published" name="is_published" 
                                           <?php echo e(old('is_published', $fitflix_short->is_published) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" 
                                           <?php echo e(old('is_featured', $fitflix_short->is_featured) ? 'checked' : ''); ?>>
                ...
                <div class="content-card-body">
                    ...
                    <?php if($categories->count() === 0): ?>
                        <div class="alert alert-warning">
                            ...
                            <a href="<?php echo e(route('admin.community.fitflix-shorts.categories.create')); ?>" class="btn btn-sm btn-warning">
                                Create Category
                            </a>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/fittelly.com/public_html/resources/views/admin/community/fitflix-shorts/edit.blade.php ENDPATH**/ ?>