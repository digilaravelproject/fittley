        ...
        <section class="hero-section">
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <?php endif; ?>
                    <p><?php echo e($hero ? $hero->description : 'Discover world-class fitness documentaries, live training sessions, expert guides, and the latest fitness news - all in one place.'); ?>
                    ...
                    <div class="hero-buttons">
                        ...
                        <?php if($hero && $hero->trailer_button_text): ?>
                            <a href="<?php echo e($hero->trailer_button_link ?? '#'); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitlive.daily-classes.show', $category->slug),'title' => $subCategory->title,'image' => $subCategory->banner_image ? asset('storage/app/public/' . $subCategory->banner_image) : null,'badge' => ['label' => 'Live', 'class' => 'badge-live'],'meta' => [ '<i class=\'fas fa-calendar\'></i> ' . ($subCategory->created_at?->format('M d, Y') ?? '') ]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                        ...
                                        <?php echo e($subCategory->title); ?>
                                            ...
                                            ?>
                                                <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $subCategory,'badge' => 'Live','badgeClass' => 'badge-live','url' => $route]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.portrait-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($subCategory),'badge' => 'Live','badgeClass' => 'badge-live','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($route)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
                                ...
                                <div class="content-slider">
                                    <div class="slider-container" id="fitguide-<?php echo e($category->id); ?>-slider">
                                        <?php $__currentLoopData = $allContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $content,'url' => 'fitguide.index']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.portrait-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($content),'url' => 'fitguide.index']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
...
<?php endif; ?>
                        ...
                        <?php $__currentLoopData = $fitNewsArchive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginal687407e33823081952234457745fe875 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal687407e33823081952234457745fe875 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitnews.show', $news),'title' => $news->title,'image' => $news->thumbnail ? asset('storage/app/public/' . $news->thumbnail) : null,'badge' => [
                    ...
                    <div class="content-slider">
                        <div class="slider-container" id="fitinsights-slider">
                            <?php $__currentLoopData = $fitInsights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $insight,'badge' => 'Article','badgeClass' => 'badge-single','url' => 'fitinsight.index']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.portrait-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($insight),'badge' => 'Article','badgeClass' => 'badge-single','url' => 'fitinsight.index']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
...
<?php echo $__env->make('layouts.home.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/homepage.blade.php ENDPATH**/ ?>