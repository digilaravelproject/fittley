...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.media-grid','data' => ['title' => $session->title,'image' => $session->banner_image ? asset('storage/app/public/'.$session->banner_image) : null,'url' => route('fitlive.session', $session),'type' => 'live','duration' => null,'year' => null,'rating' => $session->viewer_peak,'description' => 'By ' . $session->instructor->name,'badgeClass' => 'live-badge']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                        ...
                        <?php if($categoryUpcoming->count() > 0): ?>
                            ...
                            <div class="media-grid-wrapper mb-4">
                                <?php $__currentLoopData = $categoryUpcoming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if (isset($component)) { $__componentOriginalc758cb2babd8d0e77fd718754f273bf5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc758cb2babd8d0e77fd718754f273bf5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.media-grid','data' => ['title' => $session->title,'image' => $session->banner_image ? asset('storage/app/public/'.$session->banner_image) : null,'url' => route('fitlive.session', $session),'type' => 'upcoming','duration' => null,'year' => $session->scheduled_at->format('Y'),'rating' => null,'badgeClass' => 'upcoming-badge','description' => 'By ' .
                                            $session->instructor->name .
                                            ' | ' .
                                            $session->scheduled_at->format('M d, g:i A')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.media-grid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                        ...
                        <?php if($categoryRecent->count() > 0): ?>
                            ...
                            <div class="media-grid-wrapper">
                                <?php $__currentLoopData = $categoryRecent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if (isset($component)) { $__componentOriginalc758cb2babd8d0e77fd718754f273bf5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc758cb2babd8d0e77fd718754f273bf5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.media-grid','data' => ['title' => $session->title,'image' => $session->banner_image ? asset('storage/app/public/'.$session->banner_image) : null,'url' => route('fitlive.session', $session),'type' => 'ended','duration' => null,'year' => $session->updated_at->format('Y'),'rating' => null,'badgeClass' => 'ended-badge','description' => 'By ' .
                                            $session->instructor->name .
                                            ' | Ended on ' .
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/public/fitlive/index.blade.php ENDPATH**/ ?>