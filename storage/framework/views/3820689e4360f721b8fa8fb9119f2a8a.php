                ...
                <section class="content-section" data-type="upcoming">
                    ...
                    <div class="media-grid-wrapper">
                        <?php $__currentLoopData = $upcomingStreams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stream): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginalc758cb2babd8d0e77fd718754f273bf5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc758cb2babd8d0e77fd718754f273bf5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.media-grid','data' => ['title' => $stream->title,'image' => $stream->thumbnail ? asset('storage/app/public/' . $stream->thumbnail) : null,'url' => route('fitnews.show', $stream),'type' => 'upcoming','badgeClass' => 'upcoming-badge','year' => optional($stream->scheduled_at)->format('Y'),'description' => 'By ' .
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stream->title),'image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stream->thumbnail ? asset('storage/app/public/' . $stream->thumbnail) : null),'url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('fitnews.show', $stream)),'type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('upcoming'),'badgeClass' => 'upcoming-badge','year' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(optional($stream->scheduled_at)->format('Y')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('By ' .
                                    optional($stream->creator)->name .
                                    ' | ' .
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/public/fitnews/index.blade.php ENDPATH**/ ?>