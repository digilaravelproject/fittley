...
<?php $__env->startSection('title', 'Stream FitArena Session'); ?>
    ...
    <div class="d-flex flex-column h-100">
        ...
        <div class="bg-dark text-white p-3 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <span id="stream-status" class="badge bg-secondary"><?php echo e(ucfirst($session->status)); ?></span>
                ...
                <a href="<?php echo e(route('admin.fitarena.show', $event->id)); ?>" class="btn btn-outline-light btn-sm">
            ...
            <div class="bg-dark text-white" style="width: 350px;">
                <div class="p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="text-muted"><?php echo e($event->title); ?></span>
                    </div>
                    
                    <div class="mb-3">
                        <strong>Session:</strong><br>
                        <span class="text-muted"><?php echo e($session->title); ?></span>
                    </div>
                    
                    <div class="mb-3">
                        <strong>Scheduled Time:</strong><br>
                        <span class="text-muted"><?php echo e($session->scheduled_start->format('M j, Y g:i A')); ?></span>
                    </div>
...
const CONFIG = {
    session: {
        ...
        status: '<?php echo e($session->status); ?>'
    },
    agora: {
...
// State
const STATE = {
    isStreaming: <?php echo e($session->status === 'live' ? 'true' : 'false'); ?>,
    client: null,
...
async function startStream() {
    try {
        ...
        const response = await fetch(`<?php echo e(route('admin.fitarena.sessions.stream-status', [$event->id, $session->id])); ?>`, {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/admin/fitarena/sessions/stream.blade.php ENDPATH**/ ?>