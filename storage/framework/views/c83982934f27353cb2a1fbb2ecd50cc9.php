...
<head>
    ...
    <title><?php echo e($fitNews->title); ?> - FitNews</title>
...
<div class="position-relative" style="height: 100vh; overflow: hidden;">
    ...
    <div id="video-container" class="position-absolute top-0 start-0 w-100 h-100 bg-dark">
        <?php if($fitNews->isLive() && $streamingConfig): ?>
        ...
        <?php else: ?>
            <div class="w-100 h-100 d-flex align-items-center justify-content-center text-white">
                <div class="text-center">
                    ...
                    <?php endif; ?>
                    <h4>
                        <?php if($fitNews->isScheduled()): ?>
                            Stream Scheduled
                        <?php elseif($fitNews->hasEnded()): ?>
                            Stream Ended
                        <?php else: ?>
                            Stream Not Live
                        <?php endif; ?>
                    </h4>
                    <?php if($fitNews->scheduled_at): ?>
                        <p>Scheduled for: <?php echo e($fitNews->scheduled_at->format('M d, Y H:i')); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="position-absolute top-0 start-0 p-3" style="z-index: 5;">
            ...
            <div class="bg-dark bg-opacity-75 text-white p-3 rounded" style="max-width: 300px;">
                <h5 class="mb-1"><?php echo e($fitNews->title); ?></h5>
                <small class="d-block mb-1">
                    <i class="fas fa-user"></i> <?php echo e($fitNews->creator->name); ?>

                </small>
                <?php if($fitNews->started_at): ?>
                    <small class="text-muted">
                        <i class="fas fa-clock"></i> Started <?php echo e($fitNews->started_at->diffForHumans()); ?>
        ...
        <div class="position-absolute top-0 end-0 p-3" style="z-index: 5;">
            <div class="d-flex flex-column gap-2 align-items-end">
                <span class="badge bg-dark bg-opacity-75 fs-6">
                    <i class="fas fa-users"></i> <span id="viewer-count"><?php echo e($fitNews->viewer_count); ?></span>
                </span>
                <span id="stream-status" class="badge bg-<?php echo e($fitNews->isLive() ? 'success' : ($fitNews->isScheduled() ? 'warning' : 'secondary')); ?> fs-6">
        ...
        <div class="position-absolute bottom-0 start-0 p-3" style="z-index: 5;">
            <div class="d-flex gap-2 align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('fitnews.index')); ?>" class="btn btn-outline-light btn-sm">
...
function shareStream() {
    if (navigator.share) {
        navigator.share({
            title: '<?php echo e($fitNews->title); ?>',
...
</html> <?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/public/fitnews/show.blade.php ENDPATH**/ ?>