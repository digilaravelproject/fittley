                            ...
                            <div class="content-slider">
                                <div class="slider-container" id="fitdoc-series-slider">
                                    <?php $__currentLoopData = $fitDocSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $video,'badge' => 'Series','badgeClass' => 'badge-series','url' => 'fitdoc.series.show']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($video),'badge' => 'Series','badgeClass' => 'badge-series','url' => 'fitdoc.series.show']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
<?php unset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $component = $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
<?php unset($__componentOriginal90de5b45bb2aa2d88794549aa0bda52d); ?>
<?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="content-slider">
                                    <div class="slider-container" id="fitlive-<?php echo e($category->id); ?>-slider">
                                        ...
                                        <?php $__currentLoopData = $allContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($category->id == 21): ?>
                                                <?php if (isset($component)) { $__componentOriginal687407e33823081952234457745fe875 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal687407e33823081952234457745fe875 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitlive.daily-classes.show', $subCategory->id),'title' => $subCategory->name,'image' => $subCategory->banner_image ? asset('storage/app/public/' . $subCategory->banner_image) : null,'badge' => ['label' => 'Live', 'class' => 'badge-live'],'meta' => ['<i class=\'fas fa-calendar\'></i> ' . ($subCategory->created_at?->format('M d, Y') ?? '')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal687407e33823081952234457745fe875)): ?>
<?php $attributes = $__attributesOriginal687407e33823081952234457745fe875; ?>
<?php unset($__attributesOriginal687407e33823081952234457745fe875); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal687407e33823081952234457745fe875)): ?>
<?php $component = $__componentOriginal687407e33823081952234457745fe875; ?>
<?php unset($__componentOriginal687407e33823081952234457745fe875); ?>
<?php endif; ?>
                                            <?php else: ?>
                                                <?php $__currentLoopData = $subCategory->fitLiveSessions->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $data,'badge' => 'Live','badgeClass' => 'badge-live','url' => $route]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.portrait-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($data),'badge' => 'Live','badgeClass' => 'badge-live','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($route)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
                        ...
                        <div class="content-slider">
                            <div class="slider-container" id="fitarena-live-slider">
                                ...
                                <?php $__currentLoopData = $fitarenaliveEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal687407e33823081952234457745fe875 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal687407e33823081952234457745fe875 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitarena.show', $event),'title' => $event->title,'image' => $event->banner_image_path ? $event->banner_image_path : null,'badge' => $badge,'meta' => ['<i class=\'fas fa-calendar\'></i> ' . ($event->created_at?->format('M d, Y') ?? '')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.landscape-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                                    ...
                                    <div class="slider-container" id="fitguide-<?php echo e($category->id); ?>-slider">
                                        <?php $__currentLoopData = $allContent->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($isFitcastLive): ?>
                                                <?php if (isset($component)) { $__componentOriginal687407e33823081952234457745fe875 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal687407e33823081952234457745fe875 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitguide.index', ['category' => $category->slug]),'title' => $content->title,'image' => $content->banner_image_path ? asset('storage/app/public/' . $content->banner_image_path) : null,'meta' => ['<i class=\'fas fa-calendar\'></i> ' . ($content->created_at?->format('M d, Y') ?? '')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.landscape-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                            <?php else: ?>
                                                <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $content,'url' => 'fitguide.index','categorySlug' => $category->slug]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.portrait-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($content),'url' => 'fitguide.index','categorySlug' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category->slug)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
                    ...
                    <div class="content-slider">
                        <div class="slider-container" id="fitnews-slider">
                            <?php $__currentLoopData = $fitNewsLive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if (isset($component)) { $__componentOriginal687407e33823081952234457745fe875 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal687407e33823081952234457745fe875 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitnews.show', $news),'title' => $news->title,'image' => $news->thumbnail ? asset('storage/app/public/' . $news->thumbnail) : null,'badge' => ['label' => 'LIVE', 'class' => 'badge-live'],'meta' => [
...
<?php endif; ?>
                            ...
                            <?php $__currentLoopData = $fitNewsArchive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Carbon\Carbon::parse($news->scheduled_at)->isToday()): ?>
                                        ...
                                        <?php if (isset($component)) { $__componentOriginal687407e33823081952234457745fe875 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal687407e33823081952234457745fe875 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.landscape-card','data' => ['route' => route('fitnews.show', $news),'title' => $news->title,'image' => $news->thumbnail ? asset('storage/app/public/' . $news->thumbnail) : null,'badge' => ['label' => $statusLabel, 'class' => $badgeClass],'meta' => [
                                        '<i class=\'fas fa-user\'></i> ' . ($news->creator->name ?? 'Admin'),
                    ...
                    <div class="content-slider">
                        <div class="slider-container" id="fitinsights-slider">
                            <?php $__currentLoopData = $fitInsights->sortBy('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal90de5b45bb2aa2d88794549aa0bda52d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.portrait-card','data' => ['video' => $insight,'url' => 'fitinsight.show']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('home.portrait-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['video' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($insight),'url' => 'fitinsight.show']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d)): ?>
<?php $attributes = $__attributesOriginal90de5b45bb2aa2d88794549aa0bda52d; ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/fittelly.com/public_html/resources/views/homepage.blade.php ENDPATH**/ ?>