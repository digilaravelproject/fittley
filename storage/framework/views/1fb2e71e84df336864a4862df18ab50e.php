...
<?php $__env->startSection('title', 'FitLive Archive'); ?>
...
<div class="admin-dashboard">
                ...
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e($recordings->total()); ?></div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e(number_format($recordings->sum('recording_duration') / 3600, 1)); ?>h</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e(number_format($recordings->sum('recording_file_size') / (1024*1024*1024), 2)); ?>GB</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e($recordings->sum('viewer_peak')); ?></div>
        ...
        <form method="GET" class="filters-form">
            <div class="filters-grid">
                ...
                <div class="filter-item">
                    ...
                    <input type="date" name="date_from" class="form-control filter-input" value="<?php echo e(request('date_from')); ?>">
                </div>
                <div class="filter-item">
                    <label class="filter-label">Date To</label>
                    <input type="date" name="date_to" class="form-control filter-input" value="<?php echo e(request('date_to')); ?>">
                </div>
                <div class="filter-item filter-search">
                    ...
                    <div class="search-input-wrapper">
                        ...
                        <input type="text" name="search" class="form-control filter-input" 
                               placeholder="Search recordings..." value="<?php echo e(request('search')); ?>">
                    </div>
                </div>
                <div class="filter-item filter-actions">
                    ...
                    <a href="<?php echo e(route('admin.fitlive.archive.index')); ?>" class="btn btn-clear">
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            ...
            <?php if($recordings->count() > 0): ?>
                <!-- Bulk Actions Form -->
                <form id="bulk-delete-form" action="<?php echo e(route('admin.fitlive.archive.bulk-delete')); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $recordings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recording): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="recording-row">
                                    <td>
                                        <input type="checkbox" name="recordings[]" value="<?php echo e($recording->id); ?>" 
                                               class="bulk-checkbox recording-checkbox" style="display: none;">
                                    </td>
                                    <td>
                                        <div class="recording-details">
                                            <div class="recording-thumbnail">
                                                <?php if($recording->banner_image): ?>
                                                    <img src="<?php echo e(asset('storage/app/public/' . $recording->banner_image)); ?>" 
                                            ...
                                            <div class="recording-info">
                                                <h6 class="recording-title"><?php echo e($recording->title); ?></h6>
                                                <?php if($recording->description): ?>
                                                    <p class="recording-description"><?php echo e(Str::limit($recording->description, 80)); ?></p>
                                                <?php endif; ?>
                                                <div class="recording-meta">
                                                    <span class="meta-item">
                                                        <i class="fas fa-calendar-alt me-1"></i>
                                                        Recorded <?php echo e($recording->ended_at->format('M d, Y')); ?>

                                                    </span>
                                                    <span class="meta-item">
                                                        <i class="fas fa-comments me-1"></i>
                                                        <?php echo e(ucfirst($recording->chat_mode)); ?> Chat
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="instructor-category">
                                            <div class="instructor-info">
                                                <div class="instructor-avatar">
                                                    <?php if($recording->instructor->avatar): ?>
                                                        <img src="<?php echo e(asset('storage/app/public/' . $recording->instructor->avatar)); ?>" alt="Instructor">
                                                    <?php else: ?>
                                                ...
                                                <div class="instructor-details">
                                                    <div class="instructor-name"><?php echo e($recording->instructor->name); ?></div>
                                                    <div class="instructor-role">Instructor</div>
                                                </div>
                                            </div>
                                            <div class="category-info">
                                                <div class="category-primary"><?php echo e($recording->category->name); ?></div>
                                                <?php if($recording->subCategory): ?>
                                                    <div class="category-secondary"><?php echo e($recording->subCategory->name); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="recording-metrics">
                                            <div class="metric-item">
                                                <span class="metric-value"><?php echo e($recording->getFormattedRecordingDuration()); ?></span>
                                                <span class="metric-label">Duration</span>
                                            </div>
                                            <div class="metric-item">
                                                <span class="metric-value"><?php echo e($recording->getFormattedRecordingFileSize()); ?></span>
                                    ...
                                    <td>
                                        <div class="views-count">
                                            <span class="metric-value"><?php echo e(number_format($recording->viewer_peak)); ?></span>
                                    ...
                                    <td>
                                        <div class="action-buttons-enhanced">
                                            <div class="primary-actions">
                                                <a href="<?php echo e(route('admin.fitlive.archive.show', $recording)); ?>" 
                                            ...
                                            <div class="secondary-actions">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="<?php echo e(route('admin.fitlive.archive.show', $recording)); ?>">
                                                                <i class="fas fa-play me-2"></i>View Recording
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="<?php echo e(route('admin.fitlive.archive.download', $recording)); ?>">
                                                                <i class="fas fa-download me-2"></i>Download
                                                            </a>
                                                        </li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <form action="<?php echo e(route('admin.fitlive.archive.destroy', $recording)); ?>" 
                ...
                <?php if($recordings->hasPages()): ?>
                    <div class="pagination-wrapper">
                        <?php echo e($recordings->appends(request()->query())->links()); ?>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <div class="empty-state-content">
                        ...
                        <a href="<?php echo e(route('admin.fitlive.sessions.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/admin/fitlive/archive/index.blade.php ENDPATH**/ ?>