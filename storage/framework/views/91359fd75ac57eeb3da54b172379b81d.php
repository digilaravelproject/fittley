<?php $__env->startSection('title', 'FitNews Management'); ?>
    ...
    <div class="page-header">
        <div class="page-header-content">
            ...
            <div class="page-actions">
                <a href="<?php echo e(route('admin.fitnews.create')); ?>" class="btn btn-primary">
                ...
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e($fitNews->total()); ?></div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e($fitNews->where('status', 'live')->count()); ?></div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e($fitNews->where('status', 'scheduled')->count()); ?></div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-card-body">
                        ...
                        <div class="stat-content">
                            <div class="stat-number"><?php echo e($fitNews->sum('viewer_count')); ?></div>
            ...
            <?php if($fitNews->count() > 0): ?>
                <div class="table-responsive">
                    <table class="table table-modern-enhanced">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $fitNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="stream-row">
                                    <td>
                                        <div class="stream-details">
                                            <div class="stream-thumbnail">
                                                <?php if($news->thumbnail): ?>
                                                    <img src="<?php echo e(asset('storage/app/public/' . $news->thumbnail)); ?>" alt="Thumbnail" class="thumbnail-img">
                                                <?php else: ?>
                                            ...
                                            <div class="stream-info">
                                                <h6 class="stream-title"><?php echo e($news->title); ?></h6>
                                                <?php if($news->description): ?>
                                                    <p class="stream-description"><?php echo e(Str::limit($news->description, 80)); ?></p>
                                                <?php endif; ?>
                                        ...
                                        <div class="status-metrics">
                                                ...
                                                <?php switch($news->status):
                                                    ...
                                                    <?php default: ?>
                                                        <span class="status-badge-enhanced status-unknown">
                                                            <i class="fas fa-question me-1"></i><?php echo e(ucfirst($news->status)); ?>
                                            ...
                                            <div class="metrics-section">
                                                <div class="metric-item">
                                                    <span class="metric-value"><?php echo e($news->viewer_count ?? 0); ?></span>
                                                    <span class="metric-label">Viewers</span>
                                                </div>
                                                <?php if($news->started_at && $news->ended_at): ?>
                                                    <div class="metric-item">
                                                        <span class="metric-value"><?php echo e($news->getDuration()); ?></span>
                                        ...
                                        <div class="creator-schedule">
                                            <div class="creator-info">
                                                <div class="creator-avatar">
                                                    <?php if($news->creator && $news->creator->avatar): ?>
                                                        <img src="<?php echo e(asset('storage/app/public/' . $news->creator->avatar)); ?>" alt="Creator">
                                                    <?php else: ?>
                                                ...
                                                <div class="creator-details">
                                                    <div class="creator-name"><?php echo e($news->creator->name ?? 'Unknown'); ?></div>
                                                    <div class="creator-role">Creator</div>
                                                </div>
                                            </div>
                                            <div class="schedule-info">
                                                <?php if($news->status === 'scheduled' && $news->scheduled_at): ?>
                                                    <div class="schedule-item">
                                                        <i class="fas fa-clock text-warning me-1"></i>
                                                        <span><?php echo e($news->scheduled_at->format('M d, H:i')); ?></span>
                                                    </div>
                                                <?php elseif($news->started_at): ?>
                                                    <div class="schedule-item">
                                                        <i class="fas fa-play-circle text-success me-1"></i>
                                                        <span><?php echo e($news->started_at->format('M d, H:i')); ?></span>
                                                    </div>
                                                <?php else: ?>
                                    ...
                                    <td>
                                        <div class="action-buttons-enhanced">
                                            <div class="primary-actions">
                                                <?php if($news->status === 'live'): ?>
                                                    <a href="<?php echo e(route('admin.fitnews.stream', $news)); ?>" 
                                                       class="btn btn-action-enhanced btn-live" 
                                                       title="Control Stream">
                                                        <i class="fas fa-video me-2"></i>Stream Control
                                                    </a>
                                                <?php elseif($news->status === 'draft' || $news->status === 'scheduled'): ?>
                                                    <a href="<?php echo e(route('admin.fitnews.edit', $news)); ?>" 
                                                       class="btn btn-action-enhanced btn-edit" 
                                                       title="Edit Stream">
                                                        <i class="fas fa-edit me-2"></i>Edit
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('admin.fitnews.show', $news)); ?>" 
                                            ...
                                            <div class="secondary-actions">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="<?php echo e(route('admin.fitnews.show', $news)); ?>">
                                                                <i class="fas fa-eye me-2"></i>View Details
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="<?php echo e(route('admin.fitnews.edit', $news)); ?>">
                                                        ...
                                                        <?php if($news->status !== 'live'): ?>
                                                            ...
                                                            <li>
                                                                <form action="<?php echo e(route('admin.fitnews.destroy', $news)); ?>" 
                                                                      method="POST" 
                                                                      class="d-inline"
                ...
                <?php if($fitNews->hasPages()): ?>
                    <div class="content-card-footer">
                        <div class="pagination-wrapper">
                            <div class="pagination-controls">
                                <?php echo e($fitNews->links('pagination.custom')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/admin/fitnews/index.blade.php ENDPATH**/ ?>