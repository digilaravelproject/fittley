<?php $__env->startSection('title', 'FitLive Stream - ' . $session->title); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><?php echo e($session->title); ?> - Streaming</h3>
                    <div class="d-flex gap-2">
                        <span class="badge bg-<?php echo e($session->isLive() ? 'success' : 'secondary'); ?> fs-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 d-flex gap-2">
                                        <button id="start-stream" class="btn btn-success" <?php echo e($session->isLive() ? 'style=display:none' : ''); ?>>
                                            <i class="fas fa-play"></i> Start Stream
                                        </button>
                                        <button id="stop-stream" class="btn btn-danger" <?php echo e(!$session->isLive() ? 'style=display:none' : ''); ?>>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span id="stream-status" class="badge bg-<?php echo e($session->isLive() ? 'success' : 'secondary'); ?>">
                                            <?php echo e(ucfirst($session->status)); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span id="viewer-count" class="badge bg-info"><?php echo e($session->viewer_peak); ?></span>
                                    </div>

                                    <?php if($session->started_at): ?>
                                    <div class="mb-3">
                                        <strong>Started:</strong><br>
                                        <small><?php echo e($session->started_at->format('M d, Y H:i:s')); ?></small>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small><?php echo e($session->scheduled_at->format('M d, Y H:i:s')); ?></small>
                                    </div>
                                    <?php endif; ?>

                                    <div class="mb-3">
                                        <strong>Channel:</strong><br>
                                        <code><?php echo e($session->getChannelName()); ?></code>
                                    </div>

                                    <div class="mb-3">
                                        <strong>Public URL:</strong><br>
                                        <a href="<?php echo e(route('fitlive.session', $session)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                    ...
                                    <div class="session-info">
                                        <h5><?php echo e($session->title); ?></h5>
                                        <?php if($session->description): ?>
                                            <p class="text-muted"><?php echo e($session->description); ?></p>
                                        <?php endif; ?>
                                        
                                        <div class="info-grid">
                                            <div class="info-item">
                                                <span class="info-label">Status</span>
                                                <span id="stream-status" class="status-badge status-<?php echo e($session->status); ?>">
                                                    <?php echo e(ucfirst($session->status)); ?>
                                            ...
                                            <div class="info-item">
                                                ...
                                                <span class="info-value"><?php echo e($session->category->name); ?></span>
                                            </div>
                                            
                                            <?php if($session->subCategory): ?>
                                            <div class="info-item">
                                                <span class="info-label">Subcategory</span>
                                                <span class="info-value"><?php echo e($session->subCategory->name); ?></span>
                                            </div>
                                            <?php endif; ?>
                                            
                                            <div class="info-item">
                                                <span class="info-label">Recording</span>
                                                <span id="recording-status" class="status-badge recording-<?php echo e($session->recording_enabled ? ($session->recording_status ?? 'ready') : 'disabled'); ?>">
                                                    <?php if($session->recording_enabled): ?>
                                                        <?php if($session->recording_status === 'recording'): ?>
                                                            <i class="fas fa-circle blink me-1"></i>Recording
                                                        <?php elseif($session->recording_status === 'completed'): ?>
                                                            <i class="fas fa-check me-1"></i>Completed
                                                        <?php elseif($session->recording_status === 'failed'): ?>
                                            ...
                                            <div class="info-item">
                                                ...
                                                <span id="viewer-count" class="info-value"><?php echo e($session->viewer_peak); ?></span>
                                            </div>
                                            
                                            <?php if($session->started_at): ?>
                                            <div class="info-item">
                                                <span class="info-label">Started</span>
                                                <span class="info-value"><?php echo e($session->started_at->format('H:i:s')); ?></span>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <small class="text-muted">
                                        Chat Mode: <strong><?php echo e(ucfirst($session->chat_mode)); ?></strong><br>
...
async function updateStreamStatus(action) {
    try {
        const response = await fetch(`/admin/fitlive/sessions/<?php echo e($session->id); ?>/${action}`, {
            method: 'POST',
            headers: {
...
const adminChatConfig = {
    ...
    chatMode: '<?php echo e($session->chat_mode); ?>',
    sessionStatus: '<?php echo e($session->status); ?>',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/admin/fitlive/sessions/stream.blade.php ENDPATH**/ ?>