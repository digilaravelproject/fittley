<?php $__env->startSection('title', 'FitArena Events'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('admin.fitarena.create')); ?>" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo e(route('admin.fitarena.index')); ?>">
                        ...
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted mb-0"><?php echo e(Str::limit($event->description, 50)); ?></p>
                                    ...
                                    <td>
                                        <span class="badge bg-info"><?php echo e(ucfirst($event->event_type ?? 'Competition')); ?></span>
                                    </td>
                                    <td>
                                        <?php switch($event->status ?? 'upcoming'):
                                            case ('live'): ?>
                                    ...
                                    <td>
                                        <?php echo e($event->start_date ? $event->start_date->format('M d, Y H:i') : 'Not set'); ?>

                                    </td>
                                    <td>
                                        <span class="badge bg-light text-dark">
                                            <?php echo e($event->stages_count ?? 0); ?> Stages
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge bg-light text-dark">
                                            <?php echo e($event->sessions_count ?? 0); ?> Sessions
                                        </span>
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="<?php echo e(route('admin.fitarena.show', $event->id)); ?>">
                                                    <i class="fas fa-eye me-2"></i>View Details
                                                </a>
                                                <a class="dropdown-item" href="<?php echo e(route('admin.fitarena.edit', $event)); ?>">
                                                    <i class="fas fa-edit me-2"></i>Edit Event
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item text-danger" href="#" onclick="confirmDelete('<?php echo e($event->id); ?>')">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/admin/fitarena/index.blade.php ENDPATH**/ ?>