                    ...
                    <div class="trainer-list">
                        <div class="trainer-item">
                            ...
                            <div class="trainer-info">
                                ...
                                <p><?php echo e($stats['total_users'] ?? 0); ?> total users</p>
                            </div>
                            <a href="<?php echo e(route('admin.users')); ?>" class="trainer-action">
                        ...
                        <div class="trainer-item">
                            ...
                            <div class="trainer-info">
                                ...
                                <p><?php echo e($stats['total_roles'] ?? 0); ?> active roles</p>
                            </div>
                            <a href="<?php echo e(route('admin.roles')); ?>" class="trainer-action">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                        <div class="trainer-item">
                            ...
                            <div class="trainer-info">
                                <h5>Permissions</h5>
                                <p><?php echo e($stats['total_permissions'] ?? 0); ?> permissions</p>
                            </div>
                            <a href="<?php echo e(route('admin.permissions')); ?>" class="trainer-action">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="activity-list">
                        <div class="activity-item">
                            ...
                            <a href="<?php echo e(route('admin.users.create')); ?>" class="activity-btn">
                    ...
                    <div class="output-items">
                        <div class="output-item">
                            ...
                            <div class="output-info">
                                ...
                                <span class="output-value"><?php echo e($stats['total_users'] ?? 0); ?> users</span>
                            </div>
                ...
                <div class="card-body">
                    <div class="food-grid">
                        ...
                        <div class="food-item">
                            ...
                            <div class="food-info">
                                <h5>Environment</h5>
                                <p><?php echo e(ucfirst(app()->environment())); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u945294333/domains/purple-gaur-534336.hostingersite.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>