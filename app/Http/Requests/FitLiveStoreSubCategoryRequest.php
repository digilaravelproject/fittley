...
class FitLiveStoreSubCategoryRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'category_id' => 'required|exists:fitlive_categories,id',
            'name' => [
                'required',
                'string',
                'max:255',
                Rule::unique('fitlive_subcategories', 'name')
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('fitlive_subcategories', 'slug')->ignore($this->route('subcategory')?->id)
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'is_active.required' => 'Please specify if the subcategory should be active.',
